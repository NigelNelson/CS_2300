...
command="horovodrun -np 2 -H localhost:2 python Lab10.py --data /data/cs2300/L9/fruits --batch_size 32 --epochs 5 --main_dir /home/derek/CS2300W21/Lab10 --augment_data false --fine_tune false"
